...
unif_maps=["unif_map_5","unif_map_all","unif_map_all_1way"]#["unif_map_1","unif_map_2","unif_map_3","unif_map_5","unif_map_all","unif_map_all_1way"]
for unif_map in unif_maps
    println("\n ---- Solve for map $unif_map")
    solve_with_k(true,unif_map,benchmark,G,Gtype)
end

clust_maps=["clust_map_1","clust_map_2","clust_map_3","clust_map_5","clust_map_all"]
